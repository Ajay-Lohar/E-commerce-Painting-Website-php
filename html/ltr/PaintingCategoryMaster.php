      ...
      <div class="page-wrapper">
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            ...
            <form action="PaintingCategoryMasterBackEnd.php" method="post">
              <div>
                <div class="card-body">
                  <h4 class="card-title">Add Paintings Category</h4>
                    <div class="row ">
                      ...
                      <div class="mb-3 has-danger">
                        ...
                        <input  type="text" id="PaintingCategoryName" name="PaintingCategoryName" class="form-control" placeholder="John doe"/>
                      </div>
                      </div>
                     ...
                     <div class="col-md-10">
                      <div class="mb-3 has-danger">
                        ...
                        <textarea name="PaintingDiscription" id="PaintingDiscription" name="PaintingDiscription"  cols="20" rows="5" class="form-control form-control-danger" ></textarea>
                      </div>
                     </div>
