        ...
        <div class="page-breadcrumb">
          <div class="row">
            <div class="col-5 align-self-center">
              <h4 class="page-title">Enqire Master</h4>
              <div class="d-flex align-items-center">
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index">Home</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Enqire</li>
                  </ol>
                </nav>
              </div>
            </div>
            ...
            <div class="col-12">
              <div class="card">
                ...
                >
                  ...
                  <div class="col-8">
                    <h4 class="card-title mb-0">Enqire List</h4>
                  </div>
                ...
                <?php
                include 'EnqireListBackEnd.php';
                                            while($row = mysqli_fetch_array($resultData))
                                            {
                                               
                                                echo"<tr>";
                                                echo'<td>
                                                        <a href="EnqireDeleteBackEnd.php?id='.$row['id'].'"><i class="fa fa-trash" aria-hidden="true"></i></i>
                                                        </a>
                                                    </td>';
                                                echo"<td>".$row['id']."</td>";
