  ...
  <div class="row">
    <div id="content" class="col-sm-12">
      ...
      <div class="shop-content row">
        ...
        <form action="html/ltr/ContactBackEnd.php" method="post" enctype="" class="form-horizontal">
          <fieldset>
            <h3 style="text-align: center;">Contact Form <legend></legend></h3>
...
<script>
          ...
          // alert("validpan working..");
            ...
            if(reg.test(phone))
            {
                ...
                document.getElementById('text_Pan2').innerHTML="PHONE NO ✓ ";
            }else{
                //alert('false');
		...
		function YourEmail(){
          // alert("validpan working..");
            ...
            if(reg.test(E_mail))
            {
                ...
                document.getElementById('text_Pan1').innerHTML="Email ✓ ";
            }else{
                //alert('false');
